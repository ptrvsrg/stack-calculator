...
class PushTest
{
    ...
    private static Stream<Arguments> pushValueTestArgs() {
        return Stream.of(Arguments.of(new ArrayList<>(List.of("1.57")),
                                      1.57),
    ...
    void pushValueTest(ArrayList<String> args, Double expected) {
        Assertions.assertDoesNotThrow(() -> pushCmd.run(args,
                                                        context));
    ...
    private static Stream<Arguments> pushVariableTestArgs() {
        return Stream.of(Arguments.of(new AbstractMap.SimpleEntry<>("a",
                                                                    1.0)),
                         Arguments.of(new AbstractMap.SimpleEntry<>("a",
                                                                    3.14)),
                         Arguments.of(new AbstractMap.SimpleEntry<>("a",
                                                                    3.14)));
    }
